...
class Graphics(object):
    def __init__(self, engine):
        ...
        self.day_overlay = PyDark.ui.Overlay(name="day_overlay", parent=self.engine.day_scene, size=self.engine.window_size, color=self.GREEN, endcolor=self.DARKGREEN, position=(0, 0))
        ...
        self.submit = PyDark.ui.Button(name="submit", position=(0, 225),
